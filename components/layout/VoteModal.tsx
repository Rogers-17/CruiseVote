        ...
        <div className="space-y-6">
          <div className="group relative">
            ...
            <input
              ...
              className={`w-full border bg-black ${error ? 'border-red-500' : 'focus:border-brand-yellow border-white/10'} text-brand-yellow rounded-2xl py-5 pr-4 pl-14 text-center font-black tracking-[0.4em] uppercase transition-all outline-none placeholder:tracking-normal placeholder:text-gray-800`}
              value={code}
